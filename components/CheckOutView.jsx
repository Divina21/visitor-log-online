      ...
      <div className="row g-3">
        {filteredActive.length > 0 ? (
              ...
              <div className="card border-0 shadow-sm rounded-4 h-100 p-2 bg-white">
                <div className="card-body d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      <h5 className="mb-0 fw-bold">{visitor.fullName}</h5>
                      <small className="text-muted d-flex align-items-center gap-1">
                        <Clock size={12} className="text-primary" /> Arrived {new Date(visitor.checkInTime).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}
                      </small>
                    </div>
                  </div>
          ...
          <div className="col-12 text-center py-5 bg-white rounded-4 border border-dashed border-2">
            ...
            <h5 className="fw-bold text-primary">No active visitors found</h5>
