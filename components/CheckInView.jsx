...
export default function CheckInView({ setView, formData, setFormData, onSubmit, loading }) {
  return (
        ...
        <form onSubmit={onSubmit} className="row g-4">
          <div className="col-md-6">
            ...
            <div className="input-group">
              ...
              <input required type="text" className="form-control form-control-lg bg-light border-0" placeholder="e.g. John Doe" value={formData.fullName} onChange={e => setFormData({...formData, fullName: e.target.value})} />
            </div>
          </div>
          <div className="col-md-6">
            ...
            <div className="input-group">
              ...
              <input required type="number" className="form-control form-control-lg bg-light border-0" placeholder="e.g. 5550123" value={formData.phoneNumber} onChange={e => setFormData({...formData, phoneNumber: e.target.value})} />
            </div>
          </div>
          <div className="col-md-6">
            <label className="form-label fw-bold small text-muted">Purpose of Visit</label>
            <input required type="text" className="form-control form-control-lg bg-light border-0" placeholder="e.g. Business Meeting" value={formData.purpose} onChange={e => setFormData({...formData, purpose: e.target.value})} />
          </div>
          <div className="col-md-6">
          ...
          <div className="col-12 pt-4">
            <button type="submit" disabled={loading} className="btn btn-primary btn-lg w-100 py-3 fw-bold rounded-4 shadow-sm d-inline-flex align-items-center justify-content-center gap-2">
              {loading ? (
                <><span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Checking In...</>
              ) : (
